...
the desktop app. Not yet: cold migration (phase 3) — its settings are already in Admin → VMs, labelled
**(coming soon)**: they save and hydrate like any other, but nothing reads them yet.
