...
Community List boundary. Epoch inputs currently require safe JavaScript integers;
lossless JSON representation of the full unsigned-64-bit range remains a limit.
