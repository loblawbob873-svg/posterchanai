...
| ISO | The newest proved ISO still predates this boundary | A new image, virtual install verification and physical USB boot remain open; it is not a release candidate yet |
