...
| Blossom/synced folders | Installed Gentoo 1.0.969 rendered 29 folder tiles, 30 folder entries and two synced roots with no overflow/runtime errors; full sync loop and two-fresh-device checks also pass | Installed account render verified; server-versus-device completeness remains open |
