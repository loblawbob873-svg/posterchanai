...
## 2026-08-28 Desktop 1.0.1140 / Android 1.0.1864 boundary
...
`641e7338d` pins that payload and does not change application code.

| Requirement | Current authoritative evidence | State / missing proof |
|---|---|---|
| Source regression gates | The complete client suite passed **1,834 tests plus 99 subtests**. The complete non-client suite passed **4,312 tests plus 473 subtests**, with 15 explicit environment skips and no failure | Green at the immutable source boundary; installed, authenticated and physical-device gates remain separate |
...
| Desktop artifact / Gentoo | Immutable Desktop 1.0.1140 Linux is 152,222,468 bytes; its Manifest records SHA-512 `460abcfaa42c2c3ac44c55030108a4a0f6c9f452141677adcf1a0acd8a05ec5db4022aab1f4c415516cd5b97d432173988999bc1e0ce9c735f2eb3a19560ec9b`. The public overlay exposes Desktop 1.0.1140 and shell 1.0.20260828074313 | Published. The reachable desktop installed both versions; the laptop was unreachable and remains unverified |
| Installed Desktop package | The reachable desktop's installed 1.0.1140 ASAR is 15,682,099 bytes, SHA-256 `c20e71e7520188a1d5e21d5766973f43ec766011325e23708fb7201c98606a18`. Extracting that exact ASAR passed Files/open-with/folder upload/video/Preview/PDF.js/blob cleanup/responsive Explorer, Code staged-and-rename diff/restore/editor focus, Office workspace and Email mobile gates. An isolated authenticated instance then matched 6,019 server index entries to 6,019 decrypted client entries; both synced roots matched server = manifest = disk at 11,954 and 5,792 with zero skipped, native `.conf`/SVG routing worked, and a real Collabora edit persisted through WOPI. Installed Code selected a disposable Git tree, rendered its real diff, restored it, returned to Explorer and retained exclusive full-height Code/Terminal sizing across focus. Cleanup restored exactly two visible 3,840×2,560 package-backed shell surfaces | Exact installed immutable package and authenticated interaction verified on the reachable desktop. The laptop remained unreachable and is not inferred from this result |
...
| ISO | Clean `/home/pc-5ac337fb7cb82127/livecd-final/posterchan-live-20260828.iso` is 3,571,408,896 bytes, SHA-256 `9adbfba56fbe9d0803b2a6cc4fc083b52c8787420fa2747588f8c059444678a8`. Independent inspection found hybrid MBR/GPT plus bootable BIOS and UEFI El Torito entries. Its squashfs contains Desktop 1.0.1140 and the embedded ASAR has the exact installed SHA-256 `c20e71e7520188a1d5e21d5766973f43ec766011325e23708fb7201c98606a18`. The graphical VM gate passed three consecutive post-grace frames | Structural and virtual live boot are green. Atomic publication was in progress when this row was written. An install to a disposable virtual disk and physical USB boot remain open and are not inferred from the live-session boot |
