...
- Exercise native Firefox/Telegram edge snap, clipboard and cross-monitor dragging in a sustained
  manual session. Installed two-output shell reconstruction, Music handoff and real Telegram →
  overlapping PosterChan focus/stacking are verified; the remaining external-app gestures are not.
...
| Android background music | Current signed APK 1.0.1681 is 20,353,431 bytes, SHA-256 `ba2c953feb6f8b2a41e417daafcb3cb5a31563172f1273a38f306936221eb8ac`, signer SHA-256 `ED:DF:3A:79:83:DF:49:22:1A:5A:CE:0D:0C:A5:2C:89:9D:34:EB:88:A4:15:5B:08:29:B0:5C:0A:FC:31:F3:42`, built from `7bf58ac6`. The exact-commit API-34 run 32934233239 completed all 70 device tests with zero failures/skips, including `aPlayingWebViewTrackKeepsAdvancingAfterHome` (7.679s); launcher lifecycle/double-Home and drawer tests also passed | Exact release commit, emulator and signed payload verified; physical phone remains open |
