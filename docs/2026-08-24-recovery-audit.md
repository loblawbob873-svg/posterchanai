...
| Desktop payload/delivery | Desktop 1.0.965 immutable tarball and public overlay agree at 152,141,185 bytes; the exact Gentoo package is installed with both required Code markers and two visible 3840×2560 surfaces | Verified for 1.0.965 |
