...
(posterchanai_api) — native diffusers. The bots reach the one server endpoint for both chat
and images. Import image generation from here so every listener shares the same backend.
"""
