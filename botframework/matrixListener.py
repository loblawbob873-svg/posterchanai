    ...
    for message in messages:
        ...
        if _attachment and _attachment.get("mxc_url"):
            ...
            if not prompt_text.strip():
                ...
                _opts = []
                if _is_img:
                    _opts.append("• `compress` — shrink the image · `convert` — image(s) → PDF")
                    _opts.append("• `meme <text>` — add outlined white caption text")
                    _opts.append("• `translate <language>` — read & translate the text")
                    _opts.append("• **Stamps:** `dildo` `poo` `cum` `blood` `bullethole` `fire` "
                                 "`gay` `blacked` `kosher` `blue` `barked` `consider` `chimp` `clay`")
                    _opts.append("• **Music/clip videos:** `hava` `indian` `yakety` `yamete` `curb` "
                                 "`depressing` `fahh` `helpme` `gong` `fbi` `redeem` `gigity` `beavis` "
                                 "`smell` `hood` `akbar` `retard` `whoabuddy` `seth` `robocop` `titan` `terminator` `reze` `sopranos` `cheers` "
                                 ...
                                 "`ree` `liberal` `moving` `harlem` `wasteland` `mixalot` `thug` `feltedtables` `prayer` `feliz`")
        ...
        # which processes them and posts the results back into this room.
                ...
                or lower_prompt == "glow" or lower_prompt.startswith("glow ") \
                ...
                or lower_prompt == "blue" or lower_prompt.startswith("blue ") \
                ...
                or lower_prompt == "seth" or lower_prompt.startswith("seth ") \
                or lower_prompt == "robocop" or lower_prompt.startswith("robocop ") \
                or lower_prompt == "titan" or lower_prompt.startswith("titan ") \
                or lower_prompt == "terminator" or lower_prompt.startswith("terminator ") \
                or lower_prompt == "reze" or lower_prompt.startswith("reze ") \
                ...
                or lower_prompt == "prayer" or lower_prompt.startswith("prayer ") \
                or lower_prompt == "feliz" or lower_prompt.startswith("feliz "):
            ...
            if not _media and lower_prompt.startswith("glow ") and prompt_text[len("glow"):].strip():
                ...
                if _summary and not lower_prompt.startswith(("meme", "dildo", "poo", "cum", "blood", "bullethole", "fire", "glow", "gay", "blacked", "kosher", "blue", "barked", "hava", "indian", "yakety", "yamete", "curb", "depressing", "fahh", "helpme", "gong", "fbi", "redeem", "gigity", "beavis", "smell", "hood", "akbar", "retard", "whoabuddy", "seth", "robocop", "titan", "terminator", "reze", "sopranos", "cheers", "munsters", "happydays", "dontwanttowait", "strangerthings", "adamsfamily", "xmen", "futurama", "charliesangles", "differentstroke", "seinfeld", "onepiece", "overtaken", "freebird", "kanye", "darkness", "bike", "jobs", "ree", "liberal", "moving", "harlem", "chimp", "consider", "clay", "wasteland", "mixalot", "thug", "feltedtables", "prayer", "feliz")):
