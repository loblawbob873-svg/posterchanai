...
echo "  Debian/Ubuntu: sudo apt install ffmpeg tesseract-ocr fonts-dejavu fonts-liberation"
echo "  Arch:          sudo pacman -S ffmpeg tesseract ttf-dejavu ttf-liberation"
echo "  Gentoo:        sudo emerge media-video/ffmpeg app-text/tesseract media-fonts/dejavu"
echo ""
