...
(function(root){
  'use strict';
  const DB='posterchan-concord-v1', STORE='envelopes', ICONS='icons', VERSION=2,
  ...
  root.PCConcordCache={DB,STORE,ICONS,MAX_PER_STREAM,MAX_EVENT_BYTES,MAX_TOTAL_BYTES,MAX_ICON_BYTES,put,get,page,drop,putIcon,getIcon,dropIcon,dropRoom,_reset(){dbPromise=null;}};
