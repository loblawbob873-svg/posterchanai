...
(function(){
  ...
  if(!document.querySelector('link[data-concord-css]')){
    ...
    l.href='/static/css/concord.css?v=12'; (document.head||document.documentElement).appendChild(l);
  }
