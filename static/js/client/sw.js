...
const SHELL = [
  ...
  '/static/js/client/sha256.js',
  '/static/js/client/app.js',
  '/static/js/client/instance-access.js',
  '/static/js/client/payment-targets.js',
  ...
  // Virtual Machines: loaded on demand (renderModuleView), precached so the screen and its cached
  // host list still open offline. noVNC itself is not — a console needs the network anyway.
  '/static/js/client/vms.js',
  '/static/js/client/vmrpc.js',
  '/static/js/client/vmconsole.js',
  ...
  '/static/js/client/phoneshell.js',
  ...
  '/static/js/client/webxdc.js',
  '/static/js/client/fs-android.js',
  '/static/js/client/foldersync.js',
  '/static/js/client/syncrun.js',
  '/static/js/client/syncstate.js',
  '/static/js/client/syncexec.js',
  '/static/js/client/sync.js',
  // PosterChanOS: loaded on every page, inert without the compositor bridges. Precached like the
  // rest — a script the page requests and the cache does not hold is a page that does not work
  // offline, which is the one thing this list exists to prevent.
  '/static/js/client/osfirstrun.js',
  '/static/js/client/osshell.js',
  '/static/js/client/osnative.js',
  '/static/js/client/osfirstrunui.js',
  '/static/js/client/hostfiles.js',
  '/static/js/client/termhist.js',
  ...
  '/static/js/client/profile.js',
  '/static/js/client/albums.js',
  '/static/js/client/streams.js',
  '/static/js/client/settings.js',
  '/static/js/client/files.js',
  '/static/js/client/discover.js',
