...
- **Jellyfin-compatible media server / Media Center** — connect supported Jellyfin clients using Quick Connect, browse shared video and music libraries, and stream adaptive HLS with saved playback progress. Includes Nostr-user permissions, NAS proxying, mobile/TV cover grids, full-screen playback, and persistent bandwidth/resource limits. [Setup and Docker media mounts](docs/MEDIA_CENTER.md) · [Tested clients and compatibility scope](docs/JELLYFIN_COMPATIBILITY.md).
