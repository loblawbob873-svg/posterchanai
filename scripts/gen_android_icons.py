...
def vector(name, rows):
    ...
    return (
        ...
        "\n"
        "     NO android:tint. It served nothing (every caller tints at runtime) while a vector\n"
        "     carrying a baked tint AND a runtime colour filter is the combination that renders\n"
        "     nothing at all on some platform versions. That is what 'a lot of the PosterChan apps\n"
        "     in the launcher are empty circles' looked like: the pill drawn, no glyph inside. -->\n"
