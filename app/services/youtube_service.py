...
# JS runtime for yt-dlp: use node if available (required for full YouTube extraction in nightly builds)
import shutil as _shutil
_NODE_PATH = _shutil.which('node')
_YDL_BASE_OPTS: dict = {'js_runtimes': [f'node:{_NODE_PATH}']} if _NODE_PATH else {}
