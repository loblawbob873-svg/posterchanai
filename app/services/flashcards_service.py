...
def _build_user_prompt(text: str, max_cards: int) -> str:
    return (
        ...
        "Rules:\n"
        "- GROUND EVERYTHING IN THE MATERIAL. Use only facts, problems, numbers, and operations "
        "that actually appear in the text. Do NOT invent new problems or topics, and do NOT "
        "introduce operations that aren't present (e.g. don't add division or negatives if the "
        "material has none).\n"
        "- If the material is a worksheet/list of problems, make one card per ACTUAL problem shown "
        "and compute its answer — do not make up different problems.\n"
        ...
        "- Math problems: question = the problem; answer = the final result; explanation = a short "
        "step-by-step solution. Set \"math\": true.\n"
        "- Write plain numbers and ordinary words as PLAIN TEXT. Do NOT wrap them in $...$ and do "
        "NOT use $ at all unless it's a real currency amount. Use $...$ ONLY for genuine equations, "
        "fractions, exponents, or math symbols.\n"
