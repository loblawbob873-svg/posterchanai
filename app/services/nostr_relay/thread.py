...
def _read_config() -> dict:
    ...
    try:
        ...
        cfg = {
            ...
            "ingest_kinds": [int(k) for k in (g("nostr_relay_ingest_kinds", "0,1,3,6,7,40,41,42,1111,9735,10002,10003,10005,10050,2003,2004,30003,30023,30311,34550,30402,30017,30018,30617,30618,1617,1621,1622,1623,1630,1631,1632,1633,31922,31923,31924,31925")
