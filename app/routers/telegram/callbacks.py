...
from .callbacks_misc import _cb_rem, _cb_pin, _cb_fin, _cb_prompt, _cb_help, _cb_lnk, _cb_glowtextpost, _cb_mk, _cb_plr, _cb_mtx, _cb_nostr, _cb_allpost
    ...
    try:
        ...
        if callback_query:
            ...
            if data.startswith("t:"):
                ...
                await _cb_mk(update, db, chat_id, data, callback_query, callback_query_id)
                ...
                await _cb_mtx(update, db, chat_id, data, callback_query, callback_query_id)
