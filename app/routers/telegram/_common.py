...
_HELP_SECTIONS = {
    ...
    "files": (
        ...
        "• ✨ Effects → 🔫 Makima — Makima finger-guns the image, with muzzle flashes → 8s clip\n"
...
_FX_THEMES = [
    ...
    ("🍑 Mixalot", "mixalot"), ("🤷 None of this matters", "nonematters"), ("🏴‍☠️ One Piece", "onepiece"),
