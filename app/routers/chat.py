                ...
                if data.get("type") == "message":
                    ...
                    if command:
                        ...
                        try:
                            ...
                            if command in ("compress", "clip", "convert", "translate", "meme", "dildo", "poo", "cum", "blood", "bullethole", "fire", "gay", "blacked", "kosher", "barked", "hava", "indian", "yakety", "yamete", "curb", "depressing"):
