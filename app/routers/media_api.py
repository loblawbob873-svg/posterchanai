...
async def process_media(
    ...
    try:
        if command == "compress":
            ...
            outputs, summary = await asyncio.to_thread(effects_service.alive_attachments, attachments, arg)
        elif command == "gay":
