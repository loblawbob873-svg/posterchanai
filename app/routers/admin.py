...
def _settings_text_keys() -> set:
    ...
    out -= {"turn_shared_secret", "stream_auth_secret", "monero_wallet_rpc_password"}
...
def get_settings(
    ...
    for _k in ("turn_shared_secret", "stream_auth_secret"):
...
def update_settings(
    ...
    try:
        ...
        _relay_reload_keys = ("nostr_relay_private_relays", "vmhost_enabled", "vmhost_peer_hosts",
                          "vmhost_public_relay", "vmhost_announce_relays", "vmhost_public_url", "vmhost_display_name",
