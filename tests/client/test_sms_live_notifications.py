...
@pytest.mark.parametrize('scenario',['multiwindow_reload','startup','late_login','duplicates','history','outgoing','muted','phone','active_thread','account_switch','hidden_thread','distinct_messages','catchup_before_live'])
