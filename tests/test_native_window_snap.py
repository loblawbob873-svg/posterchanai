...
def test_native_titlebars_use_the_posterchan_palette():
    # The title bar is the raised surface; the focused ACCENT is the posterchan-shell ring (see
    # tests/test_native_windows_match_the_desktop.py) -- Wayfire paints title and border one colour.
