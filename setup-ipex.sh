...
echo ""
echo "If you see 'I apologize, I wasn't able to generate a proper response':"
echo "  This can happen with thinking-mode models (Qwen3-abliterated, DeepSeek-R1)."
echo "  Solution: Use standard models like Qwen2.5, Llama-3, or Mistral instead."
echo "  In admin settings, set llm_model_path to a non-thinking model."
